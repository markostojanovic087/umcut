...
void TimelineDock::createShortTracks()
{
    ...
    const int nbShortTracks = 2; // TODO(Marko): Handle number of short tracks 
    ...
    for (int shortTrackIndex = 0; shortTrackIndex < nbShortTracks; shortTrackIndex++) {
        ...
        shortTracksPositionsX.append(clipsPositionsX); // TODO(Marko): Determine based on the person position
        
        for (int clipIndex = 0; clipIndex < 1; clipIndex++) { // TODO(Marko): Handle all clips
            clipsPositionsX.append(-sizeX / 2 + viewWidth / 2 - ((shortTrackIndex % 2 == 0) ? -offset : offset)); // TODO(Marko): Determine based on the person position
            ...
            insert(currentTrack(), clipIndex, QString(), true);
